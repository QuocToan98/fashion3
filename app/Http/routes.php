<?php
// page front-end
Route::get('/vechungtoi', 'PagesController@vechungtoi');
Route::get('/gioithieu', 'Homecontroller@gioithieu');
Route::get('/gioithieu', 'Homecontroller@sanphammoi');
...
Route::auth();
Route::get('/user', 'PagesController@index2');
Route::get('/user/edit', 'PagesController@edit');
